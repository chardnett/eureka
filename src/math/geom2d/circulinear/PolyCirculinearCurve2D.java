...
extends PolyOrientedCurve2D<T> implements CirculinearContinuousCurve2D {
     ...
     */
    public static <T extends CirculinearContinuousCurve2D> 
    PolyCirculinearCurve2D<T> createPolyCirculinear2D(Collection<T> curves, boolean closed) {
    ...
    public static CirculinearContinuousCurve2D createPolyCirculinearCurve2D(Collection<CirculinearContinuousCurve2D> parallelCurves, boolean closed) {
